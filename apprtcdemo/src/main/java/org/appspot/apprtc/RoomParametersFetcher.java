...
public class RoomParametersFetcher {
  ...
  private void roomHttpResponseParse(String response) {
    ...
    try {
      ...
      LinkedList<PeerConnection.IceServer> iceServers = getTurnServers();
   ...
   * add by jch.
   *
   * getting turn server address at location.
   * @return
   */
  private LinkedList<PeerConnection.IceServer> getTurnServers(){

    LinkedList<PeerConnection.IceServer> iceServers = new LinkedList<>();

    iceServers.add(new PeerConnection.IceServer("stun:123.126.104.237:4000"));
    iceServers.add(new PeerConnection.IceServer("turn:123.126.104.237:3478", "dooler", "123456"));
